...
/*   Updated: 2017/10/11 17:39:29 by askochul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rtv.h"

static double  check_cylinder_limits(double t, t_ray *r, t_limited_cylinder *c)
{
	t_vect tmp[2];
	t_vect  point;
...
static double  check_cone_limits(double t, t_ray *r, t_limited_cone *c)
{
	t_vect tmp[2];
	t_vect  point;
